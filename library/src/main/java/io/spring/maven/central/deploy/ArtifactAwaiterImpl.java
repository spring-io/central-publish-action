 ...
 */
class ArtifactAwaiterImpl implements ArtifactAwaiter {
	 ...
	 */
	ArtifactAwaiterImpl(Logger logger, Duration timeout, Duration sleepBetweenRetries, URI baseUri,
	...
	@Override
	public void await(Coordinates coordinates) {
